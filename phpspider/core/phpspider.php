        ...
        if (!empty($fields))
        {
            ...
            if (isset($fields) && is_array($fields))
            {
                ...
                if (!empty(self::$configs['export']))
                {
                    ...
                    {
                        $id = db::insert(self::$export_table, $fields);
                        if($id && $this->on_insert_db){
                            $insert_return = call_user_func($this->on_insert_db, $id, $page, $this);
                        }else{
                            log::warn("insert manga fail : ".$fields['title']);
                        }
                    }
                }
            }
